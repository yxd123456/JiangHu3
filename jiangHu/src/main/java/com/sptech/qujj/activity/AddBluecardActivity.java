 ...
 * 
 */
public class AddBluecardActivity extends BaseActivity implements OnClickListener, OnClickTitleListener {
	...
	public void onClick(View v) {
		...
		case R.id.btn_next:
			...
			Intent next = new Intent(AddBluecardActivity.this, AddbluecardSubActivity.class);
		...
		case R.id.rl_banktype:
			Intent banktype = new Intent(AddBluecardActivity.this, UsableBlueCardActivity.class);
		...
		case R.id.iv_cvvanswer:
			Intent answer = new Intent(AddBluecardActivity.this, BluecardJieshaoActivity.class);
			startActivity(answer);
			overridePendingTransition(R.anim.push_left_in, R.anim.push_left_out);
			break;
		case R.id.et_usedata:
			DialogData dr = new DialogData(AddBluecardActivity.this, new EventDataListener() {
	...
	private void doDecode() {
		String supportbank = spf.getString(Constant.SUPPORTBLUEBANK, "");
		System.out.println("doDecode()-- 解析信用卡列表 == " + supportbank);
