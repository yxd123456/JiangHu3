...
public class DialogBindCredit {
	...
	public DialogBindCredit(Context context, EventHandleListener eventHandleListener) {
	...
	public void createMyDialog() {
		View view = LayoutInflater.from(context).inflate(R.layout.dialog_view_bindcredit, null);
