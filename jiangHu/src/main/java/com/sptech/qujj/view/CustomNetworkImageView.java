...
public class CustomNetworkImageView extends ImageView {
	...
	public void setDefaultImage(boolean flag) {
		this.isDefault = flag;
	}
		...
		ImageContainer newContainer = mImageLoader.get(mUrl,
				new ImageListener() {
					...
					public void onResponse(final ImageContainer response,
						...
						// by posting back to the main thread.
	...
	private void setDefaultBitmap() {
		setImageResource(R.drawable.img_nobank);
	}
	...
	public void setNoDetached(boolean flag) {
		detached = flag;
	}
	...
	protected void onDetachedFromWindow() {
		if (mImageContainer != null && detached) {
