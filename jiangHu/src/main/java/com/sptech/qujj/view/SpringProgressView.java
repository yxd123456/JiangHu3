...
public class SpringProgressView extends View {
	...
	/** 分段颜色 */
	private static final int[] SECTION_COLORS = { Color.parseColor("#21a2fd"), Color.parseColor("#21a2fd") };// ,Color.parseColor("#e17aff")
	/** 进度条最大值 */
	...
	protected void onDraw(Canvas canvas) {
		...
		mPaint.setColor(Color.parseColor("#ebebeb"));// 进度条灰色的背景色

		canvas.drawRoundRect(rectBg, round, round, mPaint);
		mPaint.setColor(Color.parseColor("#EDEDED"));// 进度条灰色的背景色
		...
		if (section <= 1.0f / 2.0f) {
			...
			// (mWidth-3)*section, mHeight-2, colors,null,
