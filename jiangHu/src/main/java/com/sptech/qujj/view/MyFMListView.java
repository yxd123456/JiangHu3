...
public class MyFMListView extends ListView implements OnScrollListener {
	...
	public MyFMListView(Context context) {
		super(context);
		init(context);
	}

	public MyFMListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		headerView = (LinearLayout) inflater.inflate(R.layout.header_lv, null);
		lvHeaderTipsTv = (TextView) headerView.findViewById(R.id.head_tipsTextView);
		lvHeaderLastUpdatedTv = (TextView) headerView.findViewById(R.id.head_lastUpdatedTextView);

		lvHeaderArrowIv = (ImageView) headerView.findViewById(R.id.head_arrowImageView);
		// 设置下拉刷新图标的最小高度和宽度
		lvHeaderArrowIv.setMinimumWidth(70);
		lvHeaderArrowIv.setMinimumHeight(50);

		lvHeaderProgressBar = (ProgressBar) headerView.findViewById(R.id.head_progressBar);
	...
	public interface MyListViewScroll {
	...
	private MyListViewScroll myListViewScroll;
	public void SetOnMyListViewScroll(MyListViewScroll myListViewScroll) {
		this.myListViewScroll = myListViewScroll;
	}
