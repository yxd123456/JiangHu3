...
/**
 * 信用卡列表 Adapter (银行卡管理页面)
 * 
 * @author gusonglei
 * 
 */
public class BankBlueListAdapter extends BaseAdapter {
	...
	public BankBlueListAdapter(Activity constant, HashMap<String, String> cardMap, List<CardInfo> list) {
